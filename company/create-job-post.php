  ...
  <div class="wrapper">
              ...
              <div class="row">
                <form method="post" action="addpost.php">
                  <div class="col-md-12 latest-job ">
                    ...
                    <div class="form-group">
                      <select class="form-control  input-lg" id="qualification" name="qualification">
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2023 <a href="https://www.vit.edu/">VIT PUNE</a>.</strong> All rights
        reserved.
      </div>
    </footer>
